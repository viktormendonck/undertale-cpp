...
public:
	...
	bool GetAdventureEnd() const;
	void SetAdventureEnd(bool newVal);
...
private:
	...
	float m_ScreenTransparency{};
	const float m_MaxScreenFadingTime{2};
	...
	//info for new fights
	const float m_maxSpawnCheckDelay{1};
